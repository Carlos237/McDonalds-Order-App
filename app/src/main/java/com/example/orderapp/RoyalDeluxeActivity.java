...
public class RoyalDeluxeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drinnkName.setText("Mc Royal Deluxe");
        drinnkDescription.setText(R.string.royaldeluxe);
        imageView.setImageResource(R.drawable.royaldeluxe);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RoyalDeluxeActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity <= 0) {
                    Toast.makeText(RoyalDeluxeActivity.this, "No se puede poner una cantidad < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
