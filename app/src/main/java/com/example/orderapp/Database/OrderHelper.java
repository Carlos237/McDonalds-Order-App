...
public class OrderHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL_TABLE = "CREATE TABLE " + OrderContract.OrderEntry.TABLE_NAME + " ("
                ...
                +  OrderContract.OrderEntry.COLUMN_FRIES + " TEXT NOT NULL, "
                +  OrderContract.OrderEntry.COLUMN_TYPE + " TEXT NOT NULL, "
                +  OrderContract.OrderEntry.COLUMN_DRINK + " TEXT NOT NULL);";
