...
public class OrderProvider extends ContentProvider {
    ...
    private Uri insertCart(Uri uri, ContentValues values) {
        ...
        if(quantity == null) {
            throw new IllegalArgumentException("La calidad es requerida");
        }
        ...
        String type = values.getAsString(OrderContract.OrderEntry.COLUMN_TYPE);
        if(type == null) {
            throw new IllegalArgumentException("Requerido punto de carne");
        }
