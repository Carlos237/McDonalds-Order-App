...
public class ChickenSupremeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drinnkName.setText("Big Chicken Supreme");
        drinnkDescription.setText(R.string.supreme);
        imageView.setImageResource(R.drawable.chicksupreme);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChickenSupremeActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity <= 0) {
                    Toast.makeText(ChickenSupremeActivity.this, "No se puede poner una cantidad < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            String priceofburger = cursor.getString(price);
            String quantityofburger = cursor.getString(quantity);

            drinnkName.setText(nameofburger);
            coffeePrice.setText(priceofburger);
            quantitynumber.setText(quantityofburger);
        }
