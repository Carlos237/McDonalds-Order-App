...
public class DoubleCheeseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drinnkName.setText("Big Double Cheese");
        drinnkDescription.setText(R.string.doubles);
        imageView.setImageResource(R.drawable.doublecheese);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DoubleCheeseActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity <= 0) {
                    Toast.makeText(DoubleCheeseActivity.this, "No se puede poner una cantidad < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
